...
import { ContentLogoffLogin } from "./ContentLogoffLogin";
...
interface PropsCardLogoffLogin {
  // ContentLogoffLogin
  pptop?: string;
  ppwidth?: string;
  bordas?: string;
...
export const CardLogoffLogin: React.FC<PropsCardLogoffLogin> = ({
  pptop,
  ppwidth,
  bordas,
  ...
  const handleConfirm = React.useCallback(() => {
    console.log("[LOGOFF LOGIN] Confirm clicado");
    onConfirm?.();
  }, [onConfirm]);

  const handleCancel = React.useCallback(() => {
    console.log("[LOGOFF LOGIN] Cancel clicado");
    onCancel?.();
  }, [onCancel]);

  return (
    <ContentLogoffLogin pptop={pptop} ppwidth={ppwidth} bordas={bordas}>
      ...
      <ContentMainCollumLogin open={open} width={width} height={height}>
        <ContentMainTitleLogin titulo={titulo} />
