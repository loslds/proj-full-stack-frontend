...
interface PropsCardHlpRecepcaoPage {
  imgcardpage?: string;
  pminheight?: string;
  pwidth?: string;
  onclosesair?: () => void;
}
export const CardHlpRecepcaoPage = ({
  imgcardpage,
  onclosesair,
}: PropsCardHlpRecepcaoPage) => {
  return (
    <CardModalCenter>
      <CardModalAround>
        <M.ContainerModalImg
      ...
      <CardModalTextoColumn>
        ...
        <br />
        <CardHlpFooter
          label=" HELP PÁGINA -> RECEPÇÃO."
          texto="Assim que TERMINARMOS A ROTINA IREMOS LIBERAR, para retornar a Pagina   
          Recepção onde poderá clicar na imagem de sua atividade e usufluir do Sistema."
