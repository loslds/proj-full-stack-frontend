  ...
  return (
    <CardModalCenter>
      ...
      <CardModalTextoColumn>
        <CardHlpFooter
            label="ENCONTRARÁ UM HELP EM TODAS AS PAGINAS REFERENT AO SISTEMA LOGIN."
            texto="Cada Pagina o Help lhe dará explicação adequada de como                 utilisar o Login."
          ...
          // <br />
          // <h3>Systema de Login .</h3>
          // <p>
          //   &emsp;&emsp; - Este Sistema foi elaborado para determinar o usuário que irá    
          //   usufluir do Sistema.
          // </p>
          // <p>
          //   &emsp;&emsp; - Neste, o Sistema tráz a eficiência para controlar o 
          //   direcionamento através das informações que ele necessita para que possa 
          //   adentrar e utilizar o Sistema.
          // </p>
          // <p>
          //   &emsp;&emsp; - O objetivo é ser correspondido de acôrdo com uma
          //   logistíca, da qual tem que ser alimentado pelas informações, prestadas durante 
          //   o processo de cadastramento antecipado.
          // </p>
          // <p>
          //   Nesta tela de Acesso ao Sistema "LOGIN", encontra se as condições para que se possa Logar no Sistema 
          // </p>
          // <p>
          //   &emsp;&emsp; - A lógistica elaborada, mostra as seguintes informações na Tela.
          // </p>
          // <h3>Uma Caixa de Edição: Solicitando a Empresa que deseja utilizar.</h3>
          // <label>Obs.:</label>
          // <h3>Uma Caixa de Seleção: Solicitando uma Opção de Acesso.</h3>
          // <label>Obs.:</label>
          // <h3>Uma Caixa de Edição: Solicitando a ID:</h3>
          // <label>Obs.:</label>
          // <h3>Uma Caixa de Edição: Solicitando a PASSWORD:</h3>
          // <label>Obs.:</label>
