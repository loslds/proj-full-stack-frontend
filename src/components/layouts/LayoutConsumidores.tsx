...
import HeaderConsumidores from '../hearders/headers/HearderConsumidores';
...
interface PropsLayoutConsumidores {
  imgsys?: string;
  titbtnsys?: string;
  onclicksys?: () => void;
...
export default LayoutConsumidores;
