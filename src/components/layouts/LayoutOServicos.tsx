...
import HeaderOSevicos from '../hearders/headers/HearderOServicos';
...
interface PropsLayoutOServicos {
  imgsys?: string;
  titbtnsys?: string;
  onclicksys?: () => void;
...
export default LayoutOServicos;
