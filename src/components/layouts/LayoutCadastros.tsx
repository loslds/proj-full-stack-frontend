...
import HeaderCadastros from '../hearders/headers/HearderCadastros';
...
interface PropsLayoutCadastros {
  imgsys?: string;
  titbtnsys?: string;
  onclicksys?: () => void;
...
export default LayoutCadastros;
