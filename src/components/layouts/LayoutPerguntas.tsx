...
import HeaderPerguntas from '../hearders/headers/HearderPerguntas';
...
interface PropsLayoutPerguntas {
  imgsys?: string;
  titbtnsys?: string;
  onclicksys?: () => void;
...
export default LayoutPerguntas;
