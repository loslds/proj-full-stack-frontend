...
import HearderAdministracao from '../hearders/headers/HearderAdministracao';
...
interface PropsLayoutAdministracao {
  imgsys?: string;
  titbtnsys?: string;
  onclicksys?: () => void;
  titlepg?: string;
...
const LayoutAdministracao = ({
  ...
  ischeck,
  children,
}: PropsLayoutAdministracao) => {
  return (
    <ContentPages>
      <HearderAdministracao
        imgsys={imgsys}
        titbtnsys={titbtnsys}
...
export default LayoutAdministracao;
